...
bool D3D::CommandList::Init(ID3D12Device* pDevice, D3D12_COMMAND_LIST_TYPE type, uint32_t count)
{
    ...
    {
        auto hr = pDevice->CreateCommandAllocator(type,
    ...
    {
        auto hr = pDevice->CreateCommandList(1,
                                             type,
                                             m_pAllocators[0].Get(),
                                             nullptr,
...
ID3D12GraphicsCommandList* D3D::CommandList::Reset()
{
