...
bool Resource::VertexBuffer::Init(ID3D12Device* pDevice, size_t size, size_t stride, const void* pInitData)
{
    // 引数チェック
...
void Resource::VertexBuffer::Term()
{
    m_pVB.Reset();
    memset(&m_View, 0, sizeof(m_View));
}

void* Resource::VertexBuffer::Map() const
{
    void* ptr;
...
void Resource::VertexBuffer::Unmap()
{
    m_pVB->Unmap(0, nullptr);
}